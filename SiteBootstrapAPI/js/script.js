    ...
    if (coin !== "") {
       ...
       async function mostrarGrafico() {
          try {
             ...
             console.log("GRAFICO NÃO MONTADO")
          }
       ...
       async function atualizarPreco() {
          ...
          try {
             ...
             erro.innerHTML = "MOEDA INVÁLIDA - <p id='erroDigitacao'>VERIFIQUE OS ERROS DE DIGITAÇÃO</p>";
       ...
       submitButton.addEventListener("click", function() {
          ...
          if (criarGrafico === undefined) {
             console.log("acabou de dar erro e, está undefined e não vai montar outro grafico por cima")
          } else {
